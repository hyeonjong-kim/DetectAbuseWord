...
dataset_train = nlp.data.TSVDataset("8_2_train.txt", field_indices=[0,1], num_discard_samples=1)
dataset_test = nlp.data.TSVDataset("8_2_test.txt", field_indices=[0,1], num_discard_samples=1)
...
for e in range(num_epochs):
    ...
    for batch_id, (token_ids, valid_length, segment_ids, label) in enumerate(tqdm(test_dataloader)):
        ...
        for i in max_indices.cpu():
            result_X.append(i.numpy())
        for j in label.cpu():
            result_Y.append(j.numpy())
